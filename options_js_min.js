...
(function ()
{
    ...
    (function ()
    {
        ...
        e.addEventListener("click", r, false);
        f.addEventListener("click", v, false);
        ...
        for (var a = document.getElementsByTagName("input"), b = 0, c; c = a[b]; b++) c.addEventListener("change", w, false);
        a = document.getElementsByTagName("select");
        for (b = 0; c = a[b]; b++) c.addEventListener("change", w, false); - 1 != window.navigator.platform.toLowerCase().indexOf("mac") && (document.getElementById("popup_dblclick_key_ctrl").innerHTML = "Command", document.getElementById("popup_select_key_ctrl").innerHTML = "Command");
        v()
    })();
})();